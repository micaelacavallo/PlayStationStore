 ...
 */
public class UnchartedGameFragment extends Fragment {
    TextView mTextViewMessage;
    Button mButtonBuy;
    TextView mTextViewPrice;

    public UnchartedGameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_uncharted_game, container, false);
    ...
    public void prepareButton(View rootView) {
        ...
        mButtonBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void prepareIntent() {
                ...
                intent.putExtra(GamesFragment.GAME_NAME, GamesFragment.UNCHARTED);
    ...
    public void wireUpViews(View rootView) {
        ...
        mTextViewPrice = (TextView)rootView.findViewById(R.id.text_view_uncharted_price);
    }
