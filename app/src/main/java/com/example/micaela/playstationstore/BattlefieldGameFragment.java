 ...
 */
public class BattlefieldGameFragment extends Fragment {

    TextView mTextViewPrice;
    TextView mTextViewMessage;
    Button mButtonBuy;

    public BattlefieldGameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_battlefield_game, container, false);
    ...
    public void prepareButton(View rootView) {
        ...
        mButtonBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void prepareIntent() {
                ...
                intent.putExtra(GamesFragment.GAME_NAME, GamesFragment.BATTLEFIELD);
    ...
    public void wireUpViews(View rootView) {
        ...
        mTextViewPrice = (TextView)rootView.findViewById(R.id.text_view_battlefield_price);
    }
