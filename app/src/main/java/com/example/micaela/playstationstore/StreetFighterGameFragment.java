 ...
 */
public class StreetFighterGameFragment extends Fragment {
    TextView mTextViewMessage;
    Button mButtonBuy;
    TextView mTextViewPrice;

    public StreetFighterGameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_street_fighter, container, false);
    ...
    public void prepareButton(View rootView) {
        ...
        mButtonBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void prepareIntent() {
                ...
                intent.putExtra(GamesFragment.GAME_NAME, GamesFragment.STREET_FIGHTER);
    ...
    public void wireUpViews(View rootView) {
        ...
        mTextViewPrice = (TextView)rootView.findViewById(R.id.text_view_street_fighter_price);
    }
