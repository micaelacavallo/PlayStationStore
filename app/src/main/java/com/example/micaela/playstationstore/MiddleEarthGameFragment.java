 ...
 */
public class MiddleEarthGameFragment extends Fragment {
    TextView mTextViewMessage;
    Button mButtonBuy;
    TextView mTextViewPrice;

    public MiddleEarthGameFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_middle_earth_game, container, false);
    ...
    public void prepareButton(View rootView) {
        ...
        mButtonBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void prepareIntent() {
                ...
                intent.putExtra(GamesFragment.GAME_NAME, GamesFragment.MIDDLE_EARTH);
    ...
    public void wireUpViews(View rootView) {
        ...
        mTextViewPrice = (TextView)rootView.findViewById(R.id.text_view_middle_earth_price);
    }
